  ...
  return (
    <div style={{ padding: '40px', fontFamily: 'sans-serif', lineHeight: '1.6' }}>
      <main className="container">
        <h1 style={{ marginBottom: '20px' }}>Refund and Returns Policy</h1>
        ...
        <h3>There are certain situations where only partial refunds are granted:</h3>
        <ul>
        ...
        <p>
          If you’ve done all of this and you still have not received your refund yet, please contact us at sanatanishop2@gmail.com.
        </p>
