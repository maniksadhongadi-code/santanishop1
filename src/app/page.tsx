...
const WhatsAppIcon = () => (
  <svg
    ...
    className="h-6 w-6"
  >
    <path d="M.057 24l1.687-6.163c-1.041-1.804-1.588-3.849-1.587-5.946.003-6.556 5.338-11.891 11.893-11.891 3.181.001 6.167 1.24 8.413 3.488 2.245 2.248 3.481 5.236 3.48 8.414-.003 6.557-5.338 11.892-11.894 11.892-1.99-.001-3.951-.5-5.688-1.448l-6.305 1.654zm6.597-3.807c1.676.995 3.276 1.591 5.392 1.592 5.448 0 9.886-4.434 9.889-9.885.002-5.462-4.415-9.89-9.881-9.892-5.452 0-9.887 4.434-9.889 9.886-.001 2.269.655 4.357 1.849 6.067l-1.232 4.493 4.545-1.185z" />
  </svg>
);
...
const TwitterIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" className="h-6 w-6">
        <path d="M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 1.798-1.574 2.165-2.724-.951.564-2.005.974-3.127 1.195-.897-.957-2.178-1.555-3.594-1.555-3.179 0-5.515 2.966-4.797 6.045-4.091-.205-7.719-2.165-10.148-5.144-1.29 2.213-.669 5.108 1.523 6.574-.806-.026-1.566-.247-2.229-.616v.064c0 2.298 1.634 4.212 3.793 4.649-.418.113-.863.172-1.325.172-.304 0-.598-.03-.886-.084.629 1.956 2.445 3.379 4.6 3.419-1.618 1.267-3.639 2.022-5.84 2.022-.379 0-.753-.022-1.122-.066 2.091 1.342 4.58 2.123 7.278 2.123 8.732 0 13.507-7.238 13.507-13.507 0-.206-.005-.411-.013-.615.927-.67 1.729-1.505 2.365-2.454z"/>
    </svg>
);
        ...
        <div className="container mx-auto px-6 py-12">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
                <div className="lg:col-span-2">
                    <h2 className="text-2xl font-bold mb-4">SANATANI SHOP</h2>
                    <p className="text-gray-400 mb-4">
                        Sanatani shop is a house of all sanatan needs. We are a team of young and enthusiastic people who are working to provide you with the best of sanatani products.
                    </p>
                </div>
                <div>
                    ...
                    <ul className="space-y-2 text-gray-400">
                        ...
                        <li><a href="#" className="hover:text-white">New Arrival</a></li>
                    </ul>
                </div>
                <div>
                    <h3 className="font-bold mb-4 uppercase">QUICK LINK</h3>
                    <ul className="space-y-2 text-gray-400">
                ...
                <div>
                    ...
                    <ul className="space-y-2 text-gray-400">
                        <li><a href="#" className="hover:text-white">Privay Policy</a></li>
                        <li><a href="#" className="hover:text-white">Terms & Conditions</a></li>
                        <li><a href="#" className="hover:text-white">Refund and Return Policy</a></li>
                    </ul>
                </div>
            </div>
            <div className="mt-12 border-t border-gray-700 pt-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                    <div>
                        <h3 className="font-bold mb-2 uppercase">SUBSCRIBE TO OUR NEWSLETTER</h3>
                        <p className="text-gray-400 mb-4">Get all the latest information on Events, Sales and Offers.</p>
                        <form className="flex">
                            <input type="email" placeholder="Email address..." className="bg-gray-700 text-white px-4 py-2 rounded-l-md focus:outline-none w-full"/>
                            <button type="submit" className="bg-yellow-500 text-gray-900 px-6 py-2 rounded-r-md font-bold hover:bg-yellow-400">SUBSCRIBE</button>
                        </form>
                    </div>
